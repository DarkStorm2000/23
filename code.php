...
<body>
    ...
    ?>
    <div id="main" style="z-index: 150000;">
        <video src="<?= $file1 ?>" controls id="videoss-show"></video>
        <br>
        <div>
            <div style="position: relative;position: absolute;">
                <img src="<?= $account_holder_image; ?>" alt="" style="border-radius: 50%; width: 70px; margin-left: 20px;">
            ...
            <div id="likeamddislike">
                <a href="<?= "likes-dislikes/like.php?id=" . $id ?>" id="iconsd">
                    <button style="background: #000; border: none;">
                        <img width="50" height="50" src="https://img.icons8.com/bubbles/50/facebook-like.png" alt="like" />
                    </button>
                    <span style="display: inline-block; margin-left: 10px;"><?= $likenumber; ?> like</span>
                </a>
                <a href="<?= "likes-dislikes/Dislike.php?id=" . $id ?>">
                    <button style="background: #000; border: none;">
                        <img width="50" height="50" src="https://th.bing.com/th/id/R.31add7574ee7ed3ebed8b63aa83a3e2c?rik=FimLTczzHccVyQ&riu=http%3a%2f%2fzionproductreviews.com%2fwp-content%2fuploads%2f2017%2f09%2fdislike-512.png&ehk=NBEEc3PfqM3Xaw03f%2fgDVV65IfaTvpVljCRklHSMwmM%3d&risl=&pid=ImgRaw&r=0" alt="Dislike" />
                    </button>
                    <span style="display: inline-block; margin-bottom: 20px;"><?= $Dislikenumber; ?> Dislike</span>
                </a>
                <button onclick="copyToClipboard()" style="background: none; border: none;"><i class="fa-sharp fa-solid fa-share" style="color: #002aff; width: 80px;"></i> Share videos</button>
            </div>
        </div>
    </div>
    <style>
                ...
                <a href="<?= "show-videos.php?id=" . $idvidios ?>">
                    <div class="user-info">
                        <div class="video-container">
                            <video src="<?= $video_url ?>" style="width: 360px;" id="vidios" controls: false;></video>
                        </div>
